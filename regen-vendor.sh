...
VENDOR_SKIP_FILES_COMMON=(
    ...
    "lib/modules/5.4-gki/device_management_service_v01.ko"
    ...
    "lib/modules/5.4-gki/qcom_llcc.ko"
    ...
    "lib/modules/5.4-gki/qti_battery_charger_main.ko"
    ...
    "lib/modules/5.4-gki/sysmon_subsystem_stats.ko"
